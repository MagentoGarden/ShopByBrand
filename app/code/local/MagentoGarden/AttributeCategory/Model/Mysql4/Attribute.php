...
class MagentoGarden_AttributeCategory_Model_Mysql4_Attribute extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        // Note that the attributecategory_id refers to the key field in your database table.
        $this->_init('attributecategory/mg_ac_attribute', 'entity_id');
    }
}